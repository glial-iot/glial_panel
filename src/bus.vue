<template>
  <div>
    <v-card class="elevation-3">
      ...
      <bus-tree ref="bus_tree" v-if="bus_type === BUS_TYPE_TREE" :json="bus_values"
                :topicDelete="topic_delete"></bus-tree>
      <bus-linear v-if="bus_type === BUS_TYPE_LINEAR" :items="bus_values" :topicDelete="topic_delete"
                  :loaded="loaded"></bus-linear>
    </v-card>
