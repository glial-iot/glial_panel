<template>
   <svg aria-hidden="true" class="svg-inline--fa fa-dot-circle fa-w-16 v-icon grey--text" style="font-size: 16px;" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
